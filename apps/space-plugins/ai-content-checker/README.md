# Storyblok Nuxt 3 Space Plugin: `ai-content-checker`
...
1. Dev mode
   ...
   ```bash
   # Initial commands (1st time)
   pnpm install
   pnpm --filter ai-content-checker prepare:nuxt
...
2. Preview mode
   ...
   pnpm --filter ai-content-checker preview
